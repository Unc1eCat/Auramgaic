...
// You still must click on specific block of the structure but not any one from the structure
public class HorizontalRotationlessMatcher extends HorizontalRotationlessPosition<HorizontalRotationlessMatcher>
{
	protected World world;
	protected boolean northMatches, southMatches, eastMatches, westMatches = true;
	...
	{
		if (northMatches) northMatches = mergeWith.northMatches;
		if (southMatches) southMatches = mergeWith.southMatches;
		if (westMatches) westMatches = mergeWith.westMatches;
		if (eastMatches) eastMatches = mergeWith.eastMatches;
