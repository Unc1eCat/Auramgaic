...

{
	...
	{
		currentPosNorth = beginning;
		currentPosSouth = beginning;
		currentPosWest = beginning;
		currentPosEast = beginning;
		beginningPos = beginning;
	}
	public HorizontalRotationlessPosition(HorizontalRotationlessPosition<?> copyFrom) 
	{
		currentPosNorth = copyFrom.currentPosNorth;
		currentPosSouth = copyFrom.currentPosSouth;
		currentPosWest = copyFrom.currentPosWest;
		currentPosEast = copyFrom.currentPosEast;
	}
